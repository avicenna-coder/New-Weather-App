...
function printOnUI(dataValue, inputValue) {
    ...
    imageTemp.setAttribute("src", "https://i.im.ge/2024/10/29/kWVyly.Cloudy.png");
...
function weatherDetails3(dataValue){
    ...
    faTemperature2.setAttribute("src", "https://i.im.ge/2024/10/30/kWHOfP.humidity.png")
    let itemDetails = document.createElement("div")
...
function weatherDetails4(dataValue){
    ...
    let faTemperature2 = document.createElement("img");
    faTemperature2.setAttribute("src", "https://i.im.ge/2024/10/29/kWVyly.Cloudy.png")
    let itemDetails = document.createElement("div")
